...
import com.example.encuestaapp.databinding.FragmentEncuestaCarnePicadaBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaCarnePicadaFragment : Fragment() {
    private var _binding: FragmentEncuestaCarnePicadaBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Carne picada"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaCarnePicadaBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setCarnePicada(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaCarnePicadaFragment_to_encuestaSalchichaFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaCarnePicadaFragment_to_homeFragment)
        }
    }
