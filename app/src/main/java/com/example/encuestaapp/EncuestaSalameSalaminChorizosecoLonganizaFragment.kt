...
import com.example.encuestaapp.databinding.FragmentEncuestaSalameSalaminChorizosecoLonganizaBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaSalameSalaminChorizosecoLonganizaFragment : Fragment() {
    private var _binding: FragmentEncuestaSalameSalaminChorizosecoLonganizaBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Salame salamin chorizo seco longaniza"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaSalameSalaminChorizosecoLonganizaBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setSalameSalaminChorizosecoLonganiza(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaSalameSalaminChorizosecoLonganizaFragment_to_encuestaMortadelaFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaSalameSalaminChorizosecoLonganizaFragment_to_homeFragment)
        }
    }
