...
import com.example.encuestaapp.databinding.FragmentEncuestaCarneVacunaMagraBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaCarneVacunaMagraFragment : Fragment() {
    private var _binding: FragmentEncuestaCarneVacunaMagraBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Carne vacuna magra"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaCarneVacunaMagraBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setCarneVacunaMagra(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaCarneVacunaMagraFragment_to_encuestaCarneVacunaCortesGrasosFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaCarneVacunaMagraFragment_to_homeFragment)
        }
    }
