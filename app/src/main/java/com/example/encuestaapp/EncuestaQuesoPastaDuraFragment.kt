...
import com.example.encuestaapp.databinding.FragmentEncuestaQuesoPastaDuraBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaQuesoPastaDuraFragment : Fragment() {
    private var _binding: FragmentEncuestaQuesoPastaDuraBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Queso de pasta dura"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaQuesoPastaDuraBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setQuesoPastaDura(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaQuesoPastaDuraFragment_to_encuestaQuesoPastaSemiduraFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaQuesoPastaDuraFragment_to_homeFragment)
        }
    }
