...
import com.example.encuestaapp.databinding.FragmentEncuestaEmpanadaDeCarneBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaEmpanadaDeCarneFragment : Fragment() {
    private var _binding: FragmentEncuestaEmpanadaDeCarneBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Empanada de carne"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaEmpanadaDeCarneBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setEmpanadaDeCarne(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaEmpanadaDeCarneFragment_to_encuestaPastelDePapaFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaEmpanadaDeCarneFragment_to_homeFragment)
        }
    }
