...
import com.example.encuestaapp.databinding.FragmentEncuestaSalchichaBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaSalchichaFragment : Fragment() {
    private var _binding: FragmentEncuestaSalchichaBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Salchicha"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaSalchichaBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setSalchicha(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaSalchichaFragment_to_encuestaSalameSalaminChorizosecoLonganizaFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaSalchichaFragment_to_homeFragment)
        }
    }
