...
import com.example.encuestaapp.databinding.FragmentEncuestaCervezaOAperitivoBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaCervezaOAperitivoFragment : Fragment() {
    private var _binding: FragmentEncuestaCervezaOAperitivoBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Cerveza o aperitivo"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaCervezaOAperitivoBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setCervezaOAperitivo(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaCervezaOAperitivoFragment_to_encuestaLicorFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaCervezaOAperitivoFragment_to_homeFragment)
        }
    }
