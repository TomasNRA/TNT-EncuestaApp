...
import com.example.encuestaapp.databinding.FragmentEncuestaBebidaDeportivaOEnergizanteBinding
import com.example.encuestaapp.db.entitis.AlimentoEncuesta
import java.text.DecimalFormat


class EncuestaBebidaDeportivaOEnergizanteFragment : Fragment() {
    private var _binding: FragmentEncuestaBebidaDeportivaOEnergizanteBinding? = null
    private val binding get() = _binding!!

    private val encuestaViewModel : EncuestaViewModel by activityViewModels()

    private var alimento:String = "Bebida deportiva o energizante"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEncuestaBebidaDeportivaOEnergizanteBinding.inflate(layoutInflater, container, false)
        initListeners()
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnContinuar.setOnClickListener {
            if(::porcion.isInitialized && ::frecuencia.isInitialized && cantidad != 0){
                ...
                encuestaViewModel.setBebidaDeportivaOEnergizante(alimento)
                //encuestaViewModel.insert()
                findNavController().navigate(R.id.action_encuestaBebidaDeportivaOEnergizanteFragment_to_encuestaGaseosaClasicaFragment)
            }else {
                Toast.makeText(
                    this.context,
        ...
        binding.btnCancelar.setOnClickListener {
            findNavController().navigate(R.id.action_encuestaBebidaDeportivaOEnergizanteFragment_to_homeFragment)
        }
    }
